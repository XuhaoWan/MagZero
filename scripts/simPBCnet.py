...
import torch_geometric.nn.conv.hetero_conv
...
po_lattice = torch.eye(3) * 3.340  # Cubic lattice with edges of length 3.34 A
...
net = SimplePeriodicNetwork(
    ...
    irreps_out="1x0e + 1x1o",  # Single scalar (L=0 and even parity) to output (for example) energy
